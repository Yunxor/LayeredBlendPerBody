...
#include "LbbEdGraphNode_Blend.generated.h"
...
UCLASS()
class LAYEREDBLENDPERBODYEDITOR_API ULbbEdGraphNode_Blend : public ULbbEdGraphNode
{
	GENERATED_BODY()
...
public:
	...
	virtual const UScriptStruct* GetNodeDataStruct() const override { return FLbbGraphNodeData_Blend::StaticStruct(); }
