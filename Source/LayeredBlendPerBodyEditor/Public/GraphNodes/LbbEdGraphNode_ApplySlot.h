...
#include "LbbEdGraphNode_ApplySlot.generated.h"
...
UCLASS()
class LAYEREDBLENDPERBODYEDITOR_API ULbbEdGraphNode_ApplySlot : public ULbbEdGraphNode
{
	GENERATED_BODY()
...
public:
	...
	virtual const UScriptStruct* GetNodeDataStruct() const override { return FLbbGraphNodeData_ApplySlot::StaticStruct(); }
