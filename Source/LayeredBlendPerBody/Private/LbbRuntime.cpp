	...
	TArray<FName>& CacheSlotNames)
{
	...
	{
		const FLbbPartOperatorBase* OperatorDefinition = OperatorData.GetPtr<FLbbPartOperatorBase>();
...
FLbbRuntimeData::FLbbRuntimeData()
{
}

void FLbbRuntimeData::InitFromDefinition(
...
void FLbbRuntimeData::BuildBodyBoneBlendWeights(const USkeleton* InSkeleton)
{
...
void FLbbRuntimeData::RebuildDesiredBoneWeights(const FBoneContainer& RequiredBones)
{
...
void FLbbRuntimeData::UpdateBlendWeights(const FAnimationUpdateContext& Context)
{
...
void FLbbRuntimeData::UpdateSlotNodeWeights(const FAnimationUpdateContext& Context)
{
	for (FLbbOperatorProgramRuntimeData& BodyPart : BodyParts)
	{
